...
const NEW_MATERIAL: Template = [
  ...
  { type: "PRACTICE", weight: 6, target: "PRIMARY", evidence: 5, instructions: (o) => `Prática guiada de "${o.title}": cinco perguntas, das palavras para frases curtas e uma troca de diálogo. Corrija com gentileza e registre cada tentativa.` },
